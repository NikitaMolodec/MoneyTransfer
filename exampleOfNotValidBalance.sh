...
curl --header "Content-Type: application/json" --request POST --data '{"balance":"0", "userId":"0", "currency":"USD"}' http://0.0.0.0:8080/application/account/create/
...
printf "\nTransaction after fail:\n"
curl --header "Content-Type: application/json" --request GET http://0.0.0.0:8080/application/transaction/get/0
printf "\n"
